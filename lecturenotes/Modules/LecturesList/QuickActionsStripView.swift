...
struct QuickActionsStripView: View {
    ...
    var body: some View {
        HStack(alignment: .top) {
            ...
            QuickActionButtonView(title: "YouTube Import", systemImage: "play.rectangle", action: onImportYouTube)
            QuickActionButtonView(title: "PDF Import", systemImage: "doc.richtext", action: onImportPDF)
        }
    }
}
